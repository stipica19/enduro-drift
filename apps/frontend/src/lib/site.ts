...
export const siteUrl = "https://endurodriftbosnien.com";

// Google Analytics 4 measurement ID (isti kao na staroj stranici). Javan je, nije tajna.
export const gaMeasurementId = "G-HB03PKFBMW";
